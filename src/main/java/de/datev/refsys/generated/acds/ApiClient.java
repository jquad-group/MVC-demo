package de.datev.refsys.generated.acds;
...
import de.datev.refsys.generated.acds.auth.Authentication;
import de.datev.refsys.generated.acds.auth.HttpBasicAuth;
import de.datev.refsys.generated.acds.auth.HttpBearerAuth;
...
public class ApiClient extends JavaTimeFormatter {
    ...
    private String basePath = "https://wssec1.iws.dev.datev.de:17394/refsys";
    ...
    protected void init() {
        ...
        authentications.put("client_secret", new ApiKeyAuth("header", "X-Datev-Client-Secret"));
        authentications.put("client_id", new ApiKeyAuth("header", "X-Datev-Client-ID"));
